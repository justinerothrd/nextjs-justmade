    ...
    <main className="bg-[#F7F7F5] text-[#4B4B4B]">
      <section className="px-4 pb-12 pt-8 sm:px-6 md:pb-24 md:pt-16">
        <div className="mx-auto grid max-w-7xl items-center gap-8 md:grid-cols-[1fr_.95fr] md:gap-12">
          ...
          className="group rounded-[24px] border border-[#E6E2DD] bg-white p-3 transition-all duration-300 ease-out hover:-translate-y-[2px] hover:border-transparent hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)]"
            <img
              src="/hero-main.png"
              alt="Camp clothing"
