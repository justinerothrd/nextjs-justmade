export default function HomePage() {
  ...
  <a
    href="/shop"
    className="inline-flex items-center justify-center rounded-full bg-white px-4 py-2 text-[13px] font-medium text-[#2F3A4A] transition hover:opacity-90 sm:px-7 sm:py-3.5 sm:text-sm"
  >
    Shop Camp
  </a>
  ...
  <a
    href="/college"
    className="inline-flex items-center justify-center rounded-full border border-white/80 bg-white/10 px-4 py-2 text-[13px] font-medium text-white backdrop-blur-sm transition hover:bg-white/20 sm:px-7 sm:py-3.5 sm:text-sm"
  >
    Shop College
  </a>
</div>
