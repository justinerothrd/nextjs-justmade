const categories = {
  ...
  sleepwear: {
    ...
    products: [
      { slug: "college-pajama-shorts", name: "College Pajama Shorts", price: "$32", image: "/sleepwear.jpg" },
      { slug: "college-sleep-set", name: "College Sleep Set", price: "$65", image: "/sleepwear-set.jpg" },
    ],
  },
  accessories: {
